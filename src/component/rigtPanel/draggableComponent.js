...
import RightTabPanel from "./panelTabs";
...
const DraggableComponent = ({Employeedata}) => {
  ...
  return (
    <div ref={ref} style={quickAndDirtyStyle}>
      <RightTabPanel Employeedata={Employeedata} />
    </div>
  );
};
...
export default function Draggable({Employeedata}) {
  return (
      <DraggableComponent Employeedata={Employeedata}/>
  );
}
