...
const ShowRoutes = ({ 
  ...
  const CreateImageNode = (node) => {
    if(node.filter((item)=> item.type === "MachineIcon")){
      const Createnode = nodes.filter((item)=> item.type === "MachineIcon")
      console.log("Create new nodewith parent id :", Createnode)
      console.log("Create new nodewith parent id :", Createnode.map((item)=>item.position.x))
      const xpos = Createnode.map((item)=>item.position.x)
      const ypos = Createnode.map((item)=>item.position.y)
      const NewImageNode = {
      parenId: "",
      id: uuidv4(),
      position: {
      ...
      data: { label: '', node: '', onIconDoubbleClick: '' },
    };
    setNodes(NewImageNode)
    }
  }
                      ...
                      <Box sx={{ position: "relative" }}>
                        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                          <Tabs 
                              ...
                              >
                            <Tab style={{ fontSize: '10.5px', fontWeight: 'bold',color:'#727272', backgroundColor: value === 0 ? "#E6ECEF" : "#ffffff" }} onClick={() => HandlebottomSlide("Routes")} label="Routes" {...a11yProps(0)} />
                            <Tab style={{ fontSize: '10.5px', fontWeight: 'bold',color:'#727272', backgroundColor: value === 1 ? "#E6ECEF" : "#ffffff" }} onClick={() => HandlebottomSlide("Staff")} label="Staff" {...a11yProps(1)} />
                            <Tab style={{ fontSize: '10.5px', fontWeight: 'bold',color:'#727272', backgroundColor: value === 3 ? "#E6ECEF" : "#ffffff" }} onClick={() => HandlebottomSlide("Material")} label="Material" {...a11yProps(3)} />
                            <Tab style={{ fontSize: '10.5px', fontWeight: 'bold',color:'#727272', backgroundColor: value === 2 ? "#E6ECEF" : "#ffffff" }} onClick={() => HandlebottomSlide("Device")} label="Device" {...a11yProps(2)} />
                            <Tab style={{ fontSize: '10.5px', fontWeight: 'bold',color:'#727272', backgroundColor: value === 4 ? "#E6ECEF" : "#ffffff" }} onClick={() => HandlebottomSlide("FG Mapping")} label="Finished Goods" {...a11yProps(4)} />
                          </Tabs>
                        </Box>
              ...
              <Panel position="top-left">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <RiDeleteBinLine style={{fontSize:'15px',color:'7C7C7C'}}/>
                    </Button>
                  </OverlayTrigger>
                  <OverlayTrigger
                    delay={{ hide: 450, show: 300 }}
                  ...
                  >
                    <Button
                      style={{ width: "50px", border:'1px solid #ECECEF' }}
                      className="mt-2 savebutton"
                      id="savebutton"
                      variant="white"
                      onClick={handleEdgesandNodes}
                    >
                      <FaSave style={{color:'7C7C7C'}}/>
                    </Button>
                  </OverlayTrigger>
                </div>
                <div>
